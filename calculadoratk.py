...
n3 = Button(tela, text='4', width=8, height=4, command=lambda: num(n3))
n3.place(x=170, y=100)

n4 = Button(tela, text='5', width=8, height=4, command=lambda: num(n4))
n4.place(x=10, y=180)

n5 = Button(tela, text='6', width=8, height=4, command=lambda: num(n5))
n5.place(x=90, y=180)

n6 = Button(tela, text='7', width=8, height=4, command=lambda: num(n6))
n6.place(x=170, y=180)

n7 = Button(tela, text='8', width=8, height=4, command=lambda: num(n7))
n7.place(x=10, y=260)

n8 = Button(tela, text='9', width=8, height=4, command=lambda: num(n8))
n8.place(x=90, y=260)

n9 = Button(tela, text='0', width=8, height=4, command=lambda: num(n9))
...
result = Button(tela, text='=', width=20, height=4,
                fg='white', bg='red', command=calcular)
result.place(x=170, y=420)

limpar = Button(tela, text='C', width=8, height=4,
                fg='white', bg='black', command=limp)
